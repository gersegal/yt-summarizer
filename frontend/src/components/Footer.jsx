...
const Footer = () => {
  return (
    ...
    <footer class="bg-gray-900 p-10 font-[sans-serif] tracking-wide">
      <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
        <div class="lg:flex lg:items-center">
          <a href="javascript:void(0)">
            <img src="https://tailwindui.com/plus/img/logos/mark.svg?color=indigo&shade=500" alt="logo" class="w-52" />
          </a>
        </div>
      ...
      <p class='text-gray-300 text-sm mt-10'>© Name. All rights reserved.
      </p>
    </footer>
    </>
  )
