...
const Cards = () => {
  ...
  const [prompt, setOpen] = useState(false);
      ...
      <CardTitle />
            ...
            <div class="w-full mb-4 border border-gray-200 rounded-lg bg-yellow-100 dark:bg-yellow-100dark:border-gray-600">
                ...
                <div class="px-4 py-2 bg-yellow-100 rounded-b-lg dark:bg-yellow-100">
                    ...
                    <textarea id="editor" rows="4" class="block w-full px-0 text-sm text-gray-800 bg-yellow-100 border-0 dark:bg-yellow-100 focus:ring-0 dark:text-white dark:placeholder-gray-400" placeholder="Enter prompt" ></textarea>
                </div>
            </div>
